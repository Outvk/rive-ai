    ...
    return (
        <div className="card-mastercard flex-shrink-0">
            <div className="flip-card-inner">
              ...
              OjU2KzAwOjAw0ssWdwAAACh0RVh0ZGF0ZTp0aW1lc3RhbXAAMy0wMi0xM1QwODoxOTo1Nisw
        ...
        <div className="card-gold flex-shrink-0">
            <div className="flip-card-inner">
              ...
              LTEzVDA4OjE1OjI5KzAwOjAwY2+u1gAAAABJRU5ErkJggg==" />
                    ...
                    <p className="name">CARDHOLDER NAME</p>
                </div>
                <div className="flip-card-back">
                    <div className="strip"></div>
                    <svg version="1.1" className="contactless" id="Layer_1" xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 50 50">
