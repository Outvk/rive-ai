...
export function Mastercard() {
    return (
        <div className="card-mastercard flex-shrink-0">
            <div className="flip-card-inner">
                <div className="flip-card-front">
                    <p className="heading_8264">RIVE CARD</p>
...
export function GoldCard() {
    return (
        <div className="card-gold flex-shrink-0">
            <div className="flip-card-inner">
                <div className="flip-card-front">
                    <p className="heading_8264">RIVE PRO</p>
                    <svg className="logo" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="36" height="36" viewBox="0 0 48 48">
                        <path fill="#bfa040" d="M32 10A14 14 0 1 0 32 38A14 14 0 1 0 32 10Z"></path>
                        <path fill="#8c6900" d="M16 10A14 14 0 1 0 16 38A14 14 0 1 0 16 10Z"></path>
                        <path fill="#a07820" d="M18,24c0,4.755,2.376,8.95,6,11.48c3.624-2.53,6-6.725,6-11.48s-2.376-8.95-6-11.48 C20.376,15.05,18,19.245,18,24z"></path>
                    </svg>
                    <svg version="1.1" className="chip" id="Layer_1" xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 50 50">
                        <image id="image0" width="50" height="50" x="0" y="0" href="data:image/png;base64," />
                    </svg>
                    <p className="number">9759 2484 5269 6576</p>
                    <p className="exp">EXP</p>
                    <p className="date_8264">12/26</p>
